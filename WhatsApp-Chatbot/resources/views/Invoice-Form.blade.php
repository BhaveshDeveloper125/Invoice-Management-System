<form id="form-data" action="invoice-submit" method="post">
    @csrf
    <input type="text" name="name" class="whatsapp" placeholder="Enter Your Name" required><br>
    <input type="number" name="phone" class="whatsapp" placeholder="Enter the WhatsApp Number" pattern="[0-9]*" maxlength="10" required><br>
